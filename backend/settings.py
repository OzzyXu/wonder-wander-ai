        ...
        if self.embedding_name:
            ...
            if self.embedding_key:
                return {
                    ...
                    "authentication": {"type": "api_key", "key": self.embedding_key},
                }
            else:
                return {
                    "type": "endpoint",
...
class _AppSettings(BaseModel):
    ...
    blobstorage: Optional[_PromptflowSettings] = None
    ...
    @model_validator(mode="after")
    def set_blob_storage_settings(self) -> Self:
        try:
            self.blobstorage = _BlobStorageSettings()
